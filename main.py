...
print('Zmienna typu hexadecimal: 0x{:X}'.format(szestnastkowy))
...
#zad8
slownik = {'cd.' : 'ciąg dalszy', 'dr' : 'doktor', 'itp.' : 'i tym podobne'}
print(slownik)
...
#zad10
zdanie = input()
print(zdanie + ' ' + 'zawiera literę "a"' + ' ' + zdanie.count('a') + ' ' + 'razy')
